...
export default function NavLinks() {
  ...
  return (
    <ul className="max-md:hidden flex items-center w-full justify-between">
            ...
            >
              <Navlink>
                <span
                  ...
                  className="text-[#5A5766] transition-colors duration-300 ease-in-out hover:text-black"
                >
                  {navLink.title}
                </span>
              </Navlink>
      ...
      <div className="flex items-center gap-[32px]">
        ...
        <div className="flex items-start gap-2  ">
          {/* Status Dot */}
          <div className="circlee bg-[#008C07] w-[8px] h-[8px] rounded-full mt-[2px] outline-2 outline-[#008C0733] "></div>
          {/* Text */}
          <div className="flex flex-col leading-tight">
            <p className="font-semibold text-[14px] text-[#1E1E1E]">
              Available for Project
            </p>
            <p className="text-[14px] text-[#5A5766]">
              Early Dec 2025
            </p>
          </div>
        </div>
        {/* how to add time and location in easy way */}
        <div className="flex flex-col leading-tight">
          <p className="font-semibold text-[14px] text-[#1E1E1E]">
            {time}
          </p>
        ...
        <a href="#" className="flex items-center gap-2 text-white px-[16px] py-[12px] bg-[#5E4FC4] rounded-[999px]"><span>
          Let’s Talk
        </span><ButtonArrow /></a>
        <div>
